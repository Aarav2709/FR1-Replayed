...
-- Avatar name lookup for body sprite
local avatarNames = {
    [100] = "fox", [101] = "hamster", [102] = "panda", [103] = "frog",
    [104] = "skunk", [105] = "doe", [106] = "dog", [107] = "cat",
    [108] = "bear", [109] = "squirrel", [110] = "baldeagle", [111] = "hippo",
    [112] = "monkey", [113] = "mouse", [114] = "parrot", [115] = "penguin",
    [116] = "pig", [117] = "polarbear", [118] = "rabbit", [119] = "rhino",
    [120] = "rooster", [121] = "shark", [122] = "sheep", [123] = "tiger",
    [124] = "turtle", [125] = "unicorn", [126] = "wolf",
    [127] = "diamondDoe", [128] = "lion", [129] = "panther",
    [130] = "whiteTiger", [131] = "crane", [132] = "flamingo",
    [133] = "goldenFox",
}
...
local function createPlayerBody(name, startX, startY, group)
    -- Use accessory thumbnail (single-frame image, not sprite sheet)
    local thumbPath = "images/gui/market/accessories/" .. name .. ".png"
    local sprite = display.newImageRect(thumbPath, 64, 64)
    if not sprite then
...
function scene:enterScene(event)
    ...
    local function showCountdownImage(num)
        if countdownImg then countdownImg:removeSelf(); countdownImg = nil end
        local path
        if num > 0 then
            ...
            if player and player.removeSelf and player.goalTime < 0 and player.x >= GOAL_X then
                ...
                timer.performWithDelay(2000, function()
                    if isGameActive then
                        ...
                        local coinsWon = 0
                        if pos == 1 then coinsWon = 500
                        elseif pos == 2 then coinsWon = 250
                        elseif pos == 3 then coinsWon = 100
                        else coinsWon = 50 end
...
function scene:exitScene(event)
    ...
    if gameTimer then timer.cancel(gameTimer); gameTimer = nil end
